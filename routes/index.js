...
router.post('/manageBlog', (req, res, next) => {
  ...
  var params = [ form.id, form.author, form.title, form.image, form.content,form.link, form.date,  ];
